transale.work = {
	...
	'agroamericana': {
		'en' : '<h1>Project.</h1>\
    			<h4>Agroamericana Corp.</h4>\
		    	<p>\
		    		The company has production and commercial operations the United States, Canada and Mexico with headquarters in New Yor and California.\
		    	</p>\
		    	<img src="../img/work/agroamericana/grafico_000.png">',
		'es' : '<h1>Proyecto.</h1>\
    			<h4>Agroamericana Corp.</h4>\
		    	<p>\
		    		Identidad + Branding + Diseño Web para el holding de agronegocios con oficinas en México, California y Nueva York.\
		    	</p>\
		    	<img src="../img/work/agroamericana/grafico_000.png">'
	},
	...
	'ah_muzen' : {
		'en' : '<h1>Project.</h1>\
		    	<h4>Ah Muzen Kab.</h4>\
		    	<p>\
		    		Identity + Branding for a Honey Bee’s company in the state of Quintana Roo, Mexico. In 2014 the Honey Bee company Ah Muzen Kab expressed a desire to have a solid and structured identity and brand for the company’s objectives.\
		                <br><br>\
		...
		'es' : '<h1>Proyecto.</h1>\
		    	<h4>Ah Muzen Kab.</h4>\
		    	<p>\
		    		Identidad + Branding + Diseño Web para la sociedad cooperativa apicultora “Ah Muzen Kab” del Estado de Quintana Roo.\
		                <br><br>\
	...
	'aimalaion' : {
		'en' : '<h1>Project.</h1>\
		    	<h4>Centennial Organics.</h4>\
		    	<p>\
		    		Identity + Branding + Web design for a studio and record producer in Cholula, Puebla.\
		            <br><br>\
		...
		'es' : '<h1>Proyecto.</h1>\
		    	<h4>Centennial Organics.</h4>\
		    	<p>\
		    		Identidad + Branding + Diseño Web para un estudio/ casa productora musical en Cholula, Puebla.\
		            <br><br>\
	...
	'amerivacs' : {
		'en' : '<h1>Project.</h1>\
		    	<h4>AmeriVacS LLC.</h4>\
		    	<p>\
		    		<span class="bold">AmeriVacS</span> in an effort to build vacuum sealers that exceed industry standards for design integrity, component quality, speed, redundancy, and failsafe mechanisms. Experience that is evident in every sealer they produce: from the very first, to their latest medical vacuum sealer.\
		        <br> <br>\
	...
	'centennial' : {
		'en' : '<h1>Project.</h1>\
		    	<h4>Centennial Organics.</h4>\
		    	<p>\
		    		Identity + Branding + Web Design for a Californian new agribusiness company.\
		        <br><br>\
		...
		'es' : '<h1>Proyecto.</h1>\
		    	<h4>Centennial Organics.</h4>\
		    	<p>\
		    		Identidad + Branding + Diseño Web para una comercializadora californiana de frutas y verduras que distribuye sus productos en los principales supermercados del estado de California, Estados Unidos.\
		        <br><br>\
	...
	'cmx' : {
		'en' : '<h1>Project.</h1>\
		    	<h4>CMX.</h4>\
		    	<p>\
		    		Identity + Branding + Web Design for the project Conectando México foundation, with the objective of giving free Internet educational purpose access for specific marginal communities in Mexico city.\
		            <br><br>\
	...
	'town':{
		'en' : '<h1>Project.</h1>\
		    	<h4>FIGHTER TOWN BREWING CO.</h4>\
		    	<p>\
		    		<span class="bold">Fighter Town Brewing</span> will open San Diego\'s 2016 first contract craft brewery, solving the probelm of scaling up for local craft brewers by contracting with them to produce their beers at scale, and as the producer for national an international breweries who seek a local presence.\
		        <br> <br>\
		...
		'es' : '<h1>Proyecto.</h1>\
		    	<h4>FIGHTER TOWN BREWING CO.</h4>\
		    	<p>\
		    		Identidad + Branding + Diseño Web para la empresa Fighter Town Brewing Co. La cual será en 2016 la primera cervecería/ embotelladora artesanal en San Diego, California.\
		        <br> <br>\
	...
	'capital' : {
		'en' : '<h1>Project.</h1>\
		      ...
		      <br>\
		      <br>\
		    		Identity + Branding + Web design for the biggest marketing of electric automotive parts of the Mexican southwest region.\
		         <br>\
		         <br>\
		...
		'es' : '<h1>Proyecto.</h1>\
		      ...
		      <br>\
		      <br>\
		    		Identidad + Branding + Diseño Web para la mayor comercializadora de autopartes y refacciones automotrices del Sureste de México.\
		         <br>\
		         <br>\
...
Como cualquier otro negocio en México, había enfocado pocos recursos e interés en la creación de su imagen y en los usuarios potenciales por medio del Internet. Grupo Chapital se acerco a Le Brand para diseñar la marca que representara  mejor todos sus atributos y de esta forma poder unificar su posiciónamiento empresarial en la ciudad capital de Tuxtla Gutiérrez en el estado de Chiapas. Además, hubo la oportunidad de crear varias aplicaciones relacionadas directamente con los usuarios y de esta forma generar lazos de identidad y experiencia de marca con los consumidores.\
	...
	'marmoline' : {
		'en' : '<h1>Project.</h1>\
		    	<h4>Marmoline.</h4>\
		    	<p>\
		    		Identity + Branding + Web Design for one of the most important marble companies inn the Mexico’s southeastern region. The company extracts, distributes and sells out marble pieces for architectonic purposes.\
		              <br><br>\
		...
		'es' : '<h1>Proyecto.</h1>\
		    	<h4>Marmoline.</h4>\
		    	<p>\
		    		Identidad + Branding + Diseño Web para una de las empresas marmoleras más importantes del sureste de México. La empresa Marmoline se encarga de la extracción, venta y distribución de una gran variedad de piezas de mármol utilizados con fines de construcción.\
		              <br><br>\
	...
	'slice' : {
		...
		'es' : '<h1>Proyecto.</h1>\
		    	<h4>Sunslice LLC.</h4>\
		    	<p>\
		    		Identidad + Branding + Diseño Web para la empresa mexicana-americana comercializadora de productos con la mejor calidad. Protagonistas de la industria agrícola en México al ser grandes exportadores y mantener un negocio sustentable.\
		        <br> <br>\
	...
	'tulum' : {
		...
		'es' : '<h1>Proyecto.</h1>\
		    	<h4>Tulum. </h4>\
		    	<p>\
		    		Identidad + Branding + Diseño Web para la identidad de la administración del Gobierno de Tulúm de 2014 a 2016.\
		                <br><br>\
	...
	'vintage' : {
		...
		'es' : '<h1>Proyecto.</h1>\
		    	<h4>Vintage.</h4>\
		    	<p>\
		    		Ingeniería Editorial en la revista Vintage la cual fue premiada como Mejor Proyecto Editorial Universitario Nacional 2013 por la asosiación mexicana de diseño, la Editorial Gustavo Gili y el Fondo de Cultura Económica.\
		              <br><br>\
...
function translate_work(page, lang){
	...
	$('.pg-2').html(transale.work[page][lang]);
